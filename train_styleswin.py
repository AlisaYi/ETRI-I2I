...
if __name__ == "__main__":
    ...
    if get_rank() == 0:
        args.sample_path = os.path.join('./results/samples', f'{current_time}')
        args.checkpoint_path = os.path.join('./results/checkpoints', f'{current_time}')
        args.tensorboard_log_dir = os.path.join('./tensorboard_logs', f'{current_time}')
